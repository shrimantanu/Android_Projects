...
public class MainActivity extends AppCompatActivity implements GreenAdapter.ListItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMessageListView = (ListView) findViewById(R.id.rv_num);
        List<FriendlyMessage> friendlyMessages = new ArrayList<>();
        mMessageAdapter = new MessageAdapter(this, R.layout.disp, friendlyMessages);
        ...
        i2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    i1.setVisibility(View.GONE);
                    i2.setVisibility(View.GONE);
                    Toast.makeText(MainActivity.this, b1.getText(),
   ...
   mChild=new ChildEventListener() {
       ...
       public void onChildAdded(DataSnapshot dataSnapshot, String s) {
        FriendlyMessage gh=dataSnapshot.getValue(FriendlyMessage.class);
        mMessageAdapter.add(gh);
       }
...
myRef.addChildEventListener(mChild);
    ...
    /*    mNumbersList = (RecyclerView) findViewById(R.id.rv_num);
        ...
        mAdapter = new GreenAdapter(10, this,this);
