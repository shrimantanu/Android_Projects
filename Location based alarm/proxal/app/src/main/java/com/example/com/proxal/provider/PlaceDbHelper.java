package com.example.com.proxal.provider;
...
import com.example.com.proxal.provider.PlaceContract.PlaceEntry;

public class PlaceDbHelper extends SQLiteOpenHelper {

    // The database name
    private static final String DATABASE_NAME = "proxal.db";
