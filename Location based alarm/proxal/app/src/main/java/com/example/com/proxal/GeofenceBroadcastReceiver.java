...
public class GeofenceBroadcastReceiver extends BroadcastReceiver {
    ...
    private void sendNotification(Context context, int transitionType) {
        ...
        Intent notificationIntent = new Intent(context, com.example.com.proxal.Main2Activity.class);

        // Construct a task stack.
        TaskStackBuilder stackBuilder = TaskStackBuilder.create(context);

        // Add the main Activity to the task stack as the parent.
        stackBuilder.addParentStack(com.example.com.proxal.Main2Activity.class);
...
*/
    ...
    private void setRingerMode(Context context, int mode) {
     /*   NotificationManager nm = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
        ...
        Intent intent = new Intent(context, com.example.com.proxal.alarm.class);
